            ...
            <Col span={22}>
                ...
                <Tabs className="tabs_news">
                    <TabPane tab="娱乐新闻" key="1">
                        <News_Block type="yule" count={25}/>
                    </TabPane>
                    <TabPane tab="科技新闻" key="2">
                        <News_Block type="keji" count={25}/>
                    </TabPane>
                </Tabs>
                ...
                <div>
                    <NewsImageBlock title='国际头条' count={8} type='guonei' width='100%' imageWidth='120px'/>
                    <NewsImageBlock title='国际头条' count={16} type='yule' width='100%' imageWidth='120px'/>
                </div>
            </Col>
            <Col span={1}></Col>
        </Row>
